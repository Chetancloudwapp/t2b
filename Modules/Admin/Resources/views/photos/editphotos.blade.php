                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3 {{ $errors->has('en_name') ? 'has-danger' : '' }}">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ $photos->getTranslation('title', 'en') }}" placeholder="Enter title"> 
                                                                @error('en_name')
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3 {{ $errors->has('it_name') ? 'has-danger' : '' }}">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ $photos->getTranslation('title', 'it')  }}" placeholder="Enter title"> 
                                                                @error('it_name')
                                                                    <div class="col-form-alert-label">
                                                                        {{ $message }}
                                                                    </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3 {{ $errors->has('de_name') ? 'has-danger' : '' }}">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ $photos->getTranslation('title', 'de')  }}" placeholder="Enter title"> 
                                                                @error('de_name')
                                                                    <div class="col-form-alert-label">
                                                                        {{ $message }}
                                                                    </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3 {{ $errors->has('fr_name') ? 'has-danger' : '' }}">
                                                                ...
                                                                <input
                                                                    ...
                                                                    value="{{ $photos->getTranslation('title', 'fr')  }}" placeholder="Enter title"> 
                                                                @error('fr_name')
                                                                    <div class="col-form-alert-label">
                                                                        {{ $message }}
                                                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media-left">
                                        <ul class="multiImg">
                                            @foreach($photos['photosgallery'] as $value)
                                            <li>
                                                @if($value['photo_id'] == $photos['id'])
                                                    <a target="_blank" href="{{ asset('uploads/photos/'. $value['images'])}}"><img src="{{ $value['images'] != '' ? asset('uploads/photos/'. $value['images']) : asset('assets/upload/placeholder.png') }}"  class="user-img img-css" id="image_1">
                                                    </a>&nbsp;
                                                    <a href="{{ url('admin/photos/deleteImage/'. $value['id'])}}" title="Delete Image" name="photos" title="Delete Photos"> <i class="fa-solid fa-trash" style="color: red;"></i> 
                                                    </a>
                                                @endif  
                                            </li>
                                            @endforeach
