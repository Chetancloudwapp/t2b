                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 {{ $errors->has('investment_title') ? 'has-danger' : '' }}">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('investment_title', $investments['investment_title']) }}" placeholder="Enter investment title">      
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3 {{ $errors->has('investment_detail') ? 'has-danger' : '' }}">
                                            ...
                                            name="investment_detail" type="message"
                                                placeholder="Enter investment detail">{{ old('investment_detail', $investments['investment_detail']) }}</textarea>  
